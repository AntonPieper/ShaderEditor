...
public final class SensorDataKeys {
	 ...
	 * Vector sensor.
	 */
	public static final DataKey<float[]> ROTATION_MATRIX = DataKey.create(
			"sensor.rotationMatrix",
			float[].class
	);
	 ...
	 */
	public static final DataKey<float[]> GRAVITY = DataKey.create(
			"sensor.gravity",
			float[].class
	);
	 ...
	 */
	public static final DataKey<float[]> GEOMAGNETIC = DataKey.create(
			"sensor.geomagnetic",
			float[].class
	);
	 ...
	 */
	public static final DataKey<float[]> INCLINATION_MATRIX = DataKey.create(
			"sensor.inclinationMatrix",
			float[].class
	);
	 ...
	 * accuracy).
	 */
	public static final DataKey<float[]> ROTATION_VECTOR = DataKey.create(
