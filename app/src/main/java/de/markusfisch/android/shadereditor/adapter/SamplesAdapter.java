...
public class SamplesAdapter extends BaseAdapter {
	...
	public SamplesAdapter(Context context) {
		samples = new Sample[]{
				...
				new Sample(R.raw.sample_back_camera_portal,
						R.drawable.thumbnail_camera_back,
						context.getString(R.string.sample_back_camera_portal_name),
						context.getString(R.string.sample_back_camera_portal_rationale)),
				new Sample(R.raw.sample_front_camera_ghost,
						R.drawable.thumbnail_default,
						context.getString(R.string.sample_front_camera_ghost_name),
						context.getString(R.string.sample_front_camera_ghost_rationale)),
				...
				new Sample(R.raw.sample_electric_fade,
						...
						.125f),
				new Sample(R.raw.sample_feedback_fluid,
						R.drawable.thumbnail_electric_fade,
						context.getString(R.string.sample_feedback_fluid_name),
						context.getString(R.string.sample_feedback_fluid_rationale)),
				...
				new Sample(R.raw.sample_signal_skyline,
						R.drawable.thumbnail_default,
						context.getString(R.string.sample_signal_skyline_name),
						context.getString(R.string.sample_signal_skyline_rationale)),
				new Sample(R.raw.sample_sensorium,
						R.drawable.thumbnail_default,
						context.getString(R.string.sample_sensorium_name),
						context.getString(R.string.sample_sensorium_rationale),
						.5f),
