...
public class RotationSensorManager implements SensorEventListener {
	...
	private static final RotationSensorManager instance = new RotationSensorManager();
	...
	private RotationSensorManager() {
		resetMatrices();
	}

	public static RotationSensorManager getInstance() {
		return instance;
	}
	...
	private void resetMatrices() {
		...
		java.util.Arrays.fill(gravity, 0f);
		java.util.Arrays.fill(geomagnetic, 0f);
		java.util.Arrays.fill(rotationVector, 0f);
	}
